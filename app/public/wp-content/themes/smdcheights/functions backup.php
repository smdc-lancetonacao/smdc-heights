...
function enqueue_custom_menu_assets() {
    ...
    wp_enqueue_style('map-section-style', get_template_directory_uri() . '/assets/css/featured-residences-section.css', array(), '1.0.0');
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="contact-info">
                ...
                <p><?php echo esc_html(get_theme_mod('contact_phone_2', '+63 917 123 4567')); ?></p>
